...
@section('content')
    ...
    <div class="row clearfix">
        <form action="{{route('admin.dp.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>CREATE DRINKS PURCHASE RECORDS</h2>
                    </div>
                    <div class="body">
                            ...
                            <table class="table table-bordered table-striped " id="tab_logic">
                                ...
                                <tbody>
                                    <tr id="addr0">
                                        ...
                                        <td><input type="text" name="stock_level[]" required></td>
