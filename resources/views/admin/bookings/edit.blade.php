            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="text" name="name" class="form-control" value="{{$booking->guest->name}}" disabled>
                            <label class="form-label">Name</label>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="email" name="email" class="form-control" value="{{$booking->guest->email}}" disabled>
                            <label class="form-label">Email</label>
                        </div>
                    </div><div class="form-group form-float">
                        <div class="form-line">
                            <input type="number" name="phone" class="form-control" value="{{$booking->guest->phone}}" disabled>
                            <label class="form-label">Phone</label>
                        </div>
                    </div>
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="number" name="price" class="form-control" value="{{$booking->guest->price}}" disabled>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                        ...
                        <div class="form-line {{$errors->has('room') ? 'focused error' : ''}}">
                            ...
                            <select name="room_id" class="form-control show-tick">
                                @foreach ($rooms as $room)
                                    <option value="{{ $room->id }}" {{ $booking->room->id == $room->id ? 'selected' : '' }}>{{ $room->name }} &nbsp; &nbsp;<span>&#8358;{{ $room->price }}</span></option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('floor') ? 'focused error' : ''}}">
                            ...
                            <select name="status" class="form-control show-tick">
                                <option value="1" {{ $booking->status=='1' ? 'selected' : '' }}>Reserved</option>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            <input type="number" name="nights" class="form-control" value="{{ $booking->guest->nights }}">
